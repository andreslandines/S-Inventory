import { obtenerUsuarios, obtenerUsuarioPorId, actualizarUsuario, eliminarUsuario } from "../models/usuarios.js";
...
export const putUsuarioporId = async (req, res) => {
        ...
        try{
            ...
            const { data, error } = await actualizarUsuario(id_usuario, {nombre, email, rol, contrasena: hashedcontrasena});
